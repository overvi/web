...
var prevPagination = document.querySelector(".prev-article-page");
var nextPagintation = document.querySelector(".next-article-page");
var articleContainer = document.querySelector(".articles");
var paginationContainer = document.querySelector(".article-page-number");
...
prevPagination === null || prevPagination === void 0 ? void 0 : prevPagination.addEventListener("click", function () {
    var _a;
    var activePagination = document.querySelector(".active-pagination");
...
nextPagintation === null || nextPagintation === void 0 ? void 0 : nextPagintation.addEventListener("click", function () {
    var _a;
    var activePagination = document.querySelector(".active-pagination");
...
function renderArticles(page) {
    ...
    paginatedArticles.forEach(function (item) {
...
nextPagintation === null || nextPagintation === void 0 ? void 0 : nextPagintation.addEventListener("click", function () { return nextPage(); });
prevPagination === null || prevPagination === void 0 ? void 0 : prevPagination.addEventListener("click", function () { return prevPage(); });
